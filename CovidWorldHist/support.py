...
class Worldcovid():
    ...
    def extract(dir_initial, dir_final):
        ...
        if os.path.exists(dir_initial):
            ...
            Worldcovid.trans_arquivos(dir_initial, format_two,dir_final)
    ...
    def trans_arquivos(dir_inicial, arquivos, dir_final):
        ...
        for i in arquivos:
            ...
            arq.rename(columns={'Lat': 'Latitude', 'Long_': 'Longitude', 'Country_Region': 'Country/Region'},
                       inplace=True)
            new_file = arq[
                ['Province_State', 'Country/Region', 'Last_Update', 'Confirmed', 'Deaths', 'Recovered', 'Latitude',
                 'Longitude']]
